export const projectsHero = {
  ...
  title: "Every Project Begins With Engineering.",
...
export const clientConfidence = {
  ...
  description:
    "Every project represents more than technical expertise—it reflects our commitment to collaboration, transparency, and long-term client relationships.",

  items: [
    {
      title: "Collaborative Partnership",
      description:
        "We work closely with homeowners, architects, interior designers, builders, and consultants to ensure every decision supports the overall vision.",
    },
    {
      title: "Engineering Accountability",
      description:
        "From concept through commissioning, we take ownership of every stage to deliver systems that perform as designed.",
    },
    {
      title: "Attention to Detail",
      description:
        "Every cable, every interface, and every user interaction is considered with the same level of engineering discipline.",
    },
    {
      title: "Long-Term Commitment",
      description:
        "Our relationship continues beyond project completion through maintenance, optimisation, and future system evolution.",
    },
  ],
};

export const projectMethod = {
  heading: "Our Project Delivery Method",

  description:
    "Every Visio Sonics project follows a structured engineering process designed to minimise risk, maximise quality, and deliver predictable outcomes.",

  steps: [
    {
      title: "Consultation",
      description:
        "Understanding client objectives, architecture, and functional requirements.",
    },
    {
      title: "System Design",
      description:
        "Engineering infrastructure, documentation, and technology specifications.",
    },
    {
      title: "Installation",
      description:
        "Professional implementation following engineering and industry standards.",
    },
    {
      title: "Commissioning",
      description:
        "Programming, testing, optimisation, and client handover.",
    },
  ],
};

export const luxuryLivingProject = {
  title: "Luxury Living",
